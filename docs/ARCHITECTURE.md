...
1. **Service Scoring Validation** (0 points) - Verify scoring is working correctly. Warning: tracked for abuse (5pt penalty if misused)
2. **Box Reset / Scrub** (60 points) - Reset a service to clean state
3. **Scoring Service Check** (10 points) - Check if scoring service is running
4. **Black Team Phone Consultation** (100 points) - Phone support
5. **Black Team Hands-on Consultation** (200 points) - In-person support. If consultation exceeded 45 minutes, manually adjusted to 300 points
6. **Other / General Issue** (0 points) - General issues, ticket lead manually adjusts points if needed

Ticket lead can override points during resolution for variable-cost categories.
...
**Via Web Interface:**
1. Team member navigates to `/tickets/create/`
...
- Can create new tickets via `/tickets/create/`
...
**Note:** No standalone point history page exists. Teams can view points through the scoring leaderboard if they have access.
