# Generated by Django 5.0.14 on 2025-11-06 09:15
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="ticket",
            index=models.Index(
                fields=["team", "status"], name="ticketing_t_team_id_829bf4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ticket",
            index=models.Index(
                fields=["category", "status"], name="ticketing_t_categor_77881b_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ticket",
            index=models.Index(
                fields=["assigned_to_discord_id"], name="ticketing_t_assigne_4fd9d4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ticket",
            index=models.Index(
                fields=["discord_thread_id"], name="ticketing_t_discord_341b6d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="commentratelimit",
            index=models.Index(
                fields=["ticket", "-posted_at"], name="ticketing_c_ticket__4c5370_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="commentratelimit",
            index=models.Index(
                ...
                name="ticketing_c_discord_755fb8_idx",
            ),
        ),
    ]
