...
class ReviewableMixin(models.Model):
    """Mixin for items requiring review/approval workflow.

    Usage:
        class MyModel(ReviewableMixin):
            ...
    ...
    This mixin provides:
        ...
        - approve(user): Method to approve with user tracking
        - unapprove(): Method to clear approval
    """
    ...
    def approve(self, user: User) -> None:
        """Mark this item as approved by the given user."""
...
class AuditMixin(models.Model):
    """Mixin for audit fields: created_at, updated_at, updated_by.
    ...
    This mixin provides:
        ...
        - updated_by: Optional FK to User who last updated
    """
