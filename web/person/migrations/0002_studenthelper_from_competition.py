# Move StudentHelper from competition app (state only - table already exists)
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("person", "0001_initial"),
        ("competition", "0004_delete_studenthelper_state_only"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    # Use state_operations to add model to Django state
    # without creating the database table (it already exists)
    operations = [
